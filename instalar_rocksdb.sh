...
echo -e '\e[0;31mcd app_server/lib/rocksdb-master/\e[0m'
make static_lib
echo -e '\e[0;31mmake static_lib\e[0m'
mv -i librocksdb.a ../
echo -e '\e[0;31mmv -i librocksdb.a ../\e[0m'
cp -r include/* ../
echo -e '\e[0;31mcp -r include/* ../\e[0m'
