...
ServicioChat::ServicioChat(ManejadorDeConexiones* manejadorDeConexiones, MensajeHTTPRequest* mensajeHTTP, SesionesDeUsuarios* sesiones){
    ...
    if (true){
        if (true){//Ahora me tengo que fijar si hubo match
            ...
            if(true){
                ...
                dataJson["Mensaje"] = this->mensajeHTTP->getBody();
